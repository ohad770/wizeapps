...
const companyDetails: CompanyDetail[] = [
  { label: "Registered name", value: companyName },
  {
    label: "Office",
...
const faqs = [
  {
    ...
    answer:
      `WizeApps is a software company based at ${streetAddress} in ${locality}, Israel. ${author.name} is the founder and the person who reads incoming messages. The office line is ${phoneDisplay} and email is ${siteEmail}.`,
  },
  {
