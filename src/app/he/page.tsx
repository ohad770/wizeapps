            ...
            <Reveal delay={120}>
              ...
              <div className="mt-3 space-y-4 leading-relaxed text-muted">
                <p>
                  ...
                  המותג חדש מהחברה: תחת השם WizeApps החברה פועלת מ-2026, אבל
                  הפרויקטים כאן ותיקים ממנו — האתר של דומינו רעננה מקבל
                  הזמנות כבר יותר מחמש שנים. כשאתם כותבים לנו, אתם מדברים
                  ישירות עם המהנדס שיבנה את המוצר שלכם — ההחלטות נסגרות כבר
                  בשיחה הראשונה, ושום דבר לא הולך לאיבוד בדרך בין איש מכירות,
                  מנהל פרויקט ומפתח.
                </p>
                <p>
